...
const MeetingRoom = () => {
    ...
    useEffect(() => {
        ...
        socket.on('offer', wrapJsonParse(handleOffer))

        socket.on('answer', wrapJsonParse(handleAnswer))

        socket.on('ice-candidate', wrapJsonParse(handleIceCandidate))
...
const wrapJsonParse = (func: Function) => {
